                ...
                <nav class="flex items-center justify-end gap-4">
                    ...
                    @else
                        ...
                        <a href="{{ route('auth.google', ['next_action' => 'login-only']) }}"
                            class="inline-flex items-center px-4 py-2 bg-black text-white border border-purple-500 rounded shadow hover:bg-blue-800 hover:text-white transition-colors duration-200">
                                <!-- Logo Google SVG -->
            ...
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row lg:h-auto">
                ...
                <div class="text-sm leading-relaxed flex-1 p-6 pb-12 lg:p-20 bg-black text-white shadow-inner rounded-bl-2xl rounded-br-2xl lg:rounded-tl-2xl lg:rounded-br-none transition-all duration-300 h-full">
                    ...
                    <p class="mb-4 text-white text-base leading-7">
                        ...
                        With the power of <span class="font-semibold text-purple-400">generative AI</span>, <strong>KDP Books AI</strong> helps you turn your raw ideas into polished, ready-to-publish books on <strong>Amazon KDP</strong>. 
                        <br class="hidden md:block">
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a href="{{ url('/sell') }}"
                            class="inline-block px-5 py-1.5 bg-black text-white border border-purple-500 hover:bg-blue-800 rounded-sm text-sm leading-normal">
                                Sell Page
                            </a>
                        </li>
                    </ul>
