                        ...
                        <table class="min-w-full text-sm table-auto bg-white dark:bg-gray-800">
                            ...
                            <tbody>
                                @foreach ($books as $book)
                                    ...
                                    <!-- <tr x-data="{ open: false, details: null }" class="border-t dark:border-gray-600"> -->
                                    <tr 
                                        x-data="{
                                            open: false, 
                                            details: null,
                                    ...
                                    >
                                        ...
                                        <td class="px-4 py-2">
                                            <!-- //mostra icona pdf se esiste il file  -->
                        ...
                        <!-- Modal popup -->
                                        ...
                                        >
                                            <div class="bg-white p-6 rounded shadow-lg max-w-lg w-full relative">
                                                <button @click="open = false" class="mb-4 absolute top-2 right-2 text-gray-700">Chiudi</button>
                                                <template x-if="details">
                                                    <div>
                                                        <h2 class="text-xl font-bold mb-2" x-text="details.book_title"></h2>
