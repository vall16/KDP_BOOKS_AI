...
<main class="max-w-5xl mx-auto py-16 px-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="bg-white shadow-md rounded-lg p-6 text-center">
            ...
            <a href="#" class="px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Scegli</a>
        </div>
        <div class="bg-white shadow-md rounded-lg p-6 text-center border-2 border-blue-600">
