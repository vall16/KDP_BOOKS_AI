...
@php
$classes = $active
    ? 'inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-green-500'
    : 'inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-white hover:text-green-400';
@endphp
